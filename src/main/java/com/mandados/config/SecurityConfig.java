...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    protected void configure(HttpSecurity http) throws Exception {			
        ...
        .antMatchers("/listatipocomercio").hasAuthority("ROL_ADMIN")
        .antMatchers("/listacatalogo").hasAnyAuthority("ROL_ADMIN","ROL_COMERCIO")
        .antMatchers("/listaproducto").hasAnyAuthority("ROL_ADMIN","ROL_COMERCIO","ROL_CALLCENTER")
        .antMatchers("/listapedido").hasAnyAuthority("ROL_ADMIN","ROL_CALLCENTER","ROL_COMERCIO","ROL_REPARTIDOR")
        .antMatchers("/listarcategoria").hasAnyAuthority("ROL_ADMIN","ROL_COMERCIO")
